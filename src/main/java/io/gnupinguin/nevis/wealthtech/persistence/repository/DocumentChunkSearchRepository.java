...
public interface DocumentChunkSearchRepository extends Repository<DocumentSearchProjection, UUID> {
    ...
    @Query("""
            ...
            LIMIT :limit;
            """)
    List<DocumentSearchProjection> findSimilar(@Param("vector") String queryEmbedding, @Param("limit") int limit);
